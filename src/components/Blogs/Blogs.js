...
const Blogs = () => {
    return (
        <div>
            ...
            <p>Ans: The context api is used to pass the global variables anywhere in the code. When there is need for sharing state between nested component. Context api is light in weight and easier to use. For using Context api no need to other dependencies or other third party libraries.  </p>
